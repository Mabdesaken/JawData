...
public class NotificationUtility extends ContextWrapper
{
    ...
    public static final String ANDROID_CHANNEL_ID = "com.jawdata.hackjunction.jawdata.ANDROID";
    public static final String IOS_CHANNEL_ID = "com.jawdata.hackjunction.jawdata.IOS";
